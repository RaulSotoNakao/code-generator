...
const getGeneratorToExecute = (generatorData) => import(`../../${generatorData.baseDirName}/generators/${generatorData.selectedGenerator}`)

export { getGeneratorsListNames, getGeneratorData, getGeneratorToExecute, getGeneratorsDirNameList }